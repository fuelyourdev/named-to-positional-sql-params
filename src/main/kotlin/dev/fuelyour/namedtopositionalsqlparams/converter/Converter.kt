...
/**
 * Contains the positional sql query and params generated by calling the [convertNamedToPositional]
 * function.
 *
 * @param sql the sql query using positional parameters
 * @param params the list of parameters, ordered according to the positional parameters in the
 *     query
 */
data class PositionalSql internal constructor(val sql: String, val params: List<Any?>)

/**
 * Contains the positional sql query and param names generated by calling the
 * [prepareNamedAsPositional] function. Also contains the [convertParams] function, which will
 * generated a positional parameters list from a named parameters map.
 *
 * @param sql the sql query using positional parameters
 * @param paramNames the list of parameter names ordered by positional relevance to the query
 */
class PreparedPositionalSql internal constructor(val sql: String, val paramNames: List<String>) {

    /**
     * Converts the named parameters map into a positional parameters list according to the
     * `paramNames` property
     *
     * @param params the named parameters map
     * @return a positional parameters list generated according to the `paramNames` property
     * @throws MissingParamException if the map does not contain an expected parameter
     */
    ...
    /**
     * Convert `PreparedPositionalSql` into [PositionalSql] by using the [convertParams] function
     * and putting the sql and parameters into a [PositionalSql] object.
     *
     * @param params the named parameters map
     * @return a [PositionalSql] object with parameters generated according to the [convertParams]
     *     function
     * @throws MissingParamException if the map does not contain an expected parameter
     */
 ...
 *
 * Note that a parameter name is only allowed to consist of alphanumeric characters and the
 * underscore.
 *
 * @param sql the sql query using named parameters
 * @param params the map of parameter names to parameter values
 * @return a [PositionalSql] object containing the sql query using positional parameters and
...
/**
 * Converts a sql query using named parameters into a sql query using positional parameter, and a
 * converter that can be used later for converting named parameter maps into positional parameter
 * lists. You can optionally supply a list of parameter names that it will use for the parameter
 * mapping process, but if one it not supplied, then one will be autogenerated by examining the
 * query provided.
 *
 * Note that a parameter name is only allowed to consist of alphanumeric characters and the
 * underscore.
 *
 * @param sql the sql query using named parameters
 * @param paramNames the set of parameter names, if not supplied, then will be autogenerated
 *     by examining the sql provided
 * @return a [PreparedPositionalSql] object containing the sql query using positional parameters,
 *     a list of parameter names, and a converter function
 * @throws InvalidParamKeyNameException if a key name contains characters other than alphanumeric
 *     characters and the underscore
 */
...
private fun generateParamNamesFromSql(sql: String): Set<String> {
    /*
     What we're looking for here is this: alphanumeric and underscore characters that start with
     a colon (but not two colons), and end with a non alphanumeric or underscore character.
     */
